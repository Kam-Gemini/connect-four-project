...
[https://kam-gemini.github.io/connect-four-project/](https://kam-gemini.github.io/connect-four-project/) 
...
* Created a function that randomises the starting colour, for each game the color of the first checker will be randomly selected.
